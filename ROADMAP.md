...
- **Public the GitHub repo.** `pyproject.toml` and README reference `github.com/marlinjai/orchestrator`; the repo isn't pushed yet. `uv tool install git+https://...` won't work until this lands.
